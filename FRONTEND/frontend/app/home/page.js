                ...
                <div style={{ position:"relative", width:300, flexShrink:0,
                  ...
                  <div style={{ height:380, overflow:"hidden", position:"relative" }}>
                    ...
                    <div style={{ position:"absolute", bottom:12, left:14, right:14 }}>
                      ...
                      {active.bio && (
                        <p style={{ ...M, fontSize:9, color:"rgba(255,255,255,0.45)", marginTop:4, lineHeight:1.5, overflow:"hidden", display:"-webkit-box", WebkitLineClamp:1, WebkitBoxOrient:"vertical", textShadow:"0 1px 8px rgba(0,0,0,1)" }}>{active.bio}</p>
                      )}
                    </div>
                  </div>
